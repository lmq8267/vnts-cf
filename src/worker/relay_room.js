...
<body>  
    <div id="app">  
        <div class="modal">  
            ...
            <div class="status-item">  
                <span class="status-label">Token活跃数：</span>  
                <span class="status-value">{{ status.Token活跃数 }}</span>  
            </div>  
              
            <div class="status-item">  
                <span class="status-label">客户端活跃数：</span>  
                <span class="status-value">{{ status.客户端活跃数 }}</span>  
            </div>  
  ...
  async fetch(request) {
    ...
    if (url.pathname === "/test") {
      ...
      const status = {
        ...
        Token活跃数: this.contexts.size,
        客户端活跃数: connectionCount,
      };
